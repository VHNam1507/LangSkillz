    ...
    <main>
        ...
        <div style=" width: 100% ;background-image: url('Image/LangSkillz_banner.png'); background-size: cover;">
            ...
            <section class="row d-flex justify-content-center" aria-labelledby="aspnetTitle">
                <div class="col-12 text-center">
                    ...
                    <p><a href="Account\Register.aspx" class="btn btn-primary btn-md bg-success">This is my first visit to LangSkillz </a></p>
                    <p><a href="Account\Login.aspx" class="btn btn-primary btn-md bg-info">I already have an account </a></p>
                </div>
            </section>
            <br /><br />
        </div>
        ...
        <div class="row">
            ...
            <section aria-labelledby="2ndScript">
                ...
                <p><a href="Account\Register.aspx" class="btn btn-primary btn-md">Become a member of LangSkillz right now? &raquo;</a></p
            </section>
